...
We now have a table that combines information from all three tables, and can create a visualization that conveys sampling method by country. We can use the `ggplot2` package to create a clean stacked-bar graph:
