...
The purpose of this vignette was to look at an example of joining 


Due to the introduction of site characterization modules and human questionnaire data, the PREDICT-2 database has a more complex structure than the P1 database; however, the concepts used to manipulate both databases are largely the same. The tutorial on joining P1 data is available here: [(https://ecohealthalliance.github.io/eidith/articles/eidith.html) 
