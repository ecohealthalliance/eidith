...
- https://predict2api.eidith.org/api/app/Event
- https://predict2api.eidith.org/api/app/Animal
- https://predict2api.eidith.org/api/app/Specimen
- https://predict2api.eidith.org/api/app/Test
- https://predict2api.eidith.org/api/app/Virus
- https://predict2api.eidith.org/api/app/TestIDSpecimenID
...
for checking if you have data access or if database structure has changed, e.g.:
        ...
        https://predict2api.eidith.org/api/app/Specimen?header_only=y
        
        https://predict2api.eidith.org/api/app/Event?header_only=y
        
- `lmdate_from` and `lmdate_to` allow you to filter records by their last date
   modified, e.g.:

        https://predict2api.eidith.org/api/app/Test?lmdate_from=2015-01-01
        
        https://predict2api.eidith.org/api/app/Test?lmdate_from=2015-03-01&lmdate_to=2016-11-17
        
        https://predict2api.eidith.org/api/app/Specimen?lmdate_from=2015-01-01
        
        https://predict2api.eidith.org/api/app/Specimen?lmdate_from=2015-01-01&lmdate_to=2016-11-17
