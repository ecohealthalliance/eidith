...
#' repond promptly.  You may also contact Noam Ross ([ross@ecoehalthallinace.org](mailto:ross@ecohealthalliance.org))
#' and Cale Basaraba ([basaraba@ecoehalthalliance.org](mailto:basaraba@ecohealthalliance.org)) directly.
#'
...
#' @rdname ed_contact
#' @name ed_contact
#' @aliases contact support ed_contact ed_support
NULL
